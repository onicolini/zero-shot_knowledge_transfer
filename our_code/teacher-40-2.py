...
model = create_wide_residual_network(input_shape, nb_classes=10, N=6, k=2, dropout=0.00)
...
with open('model-40-2.json', 'w') as json_file:
    json_file.write(model_json)
model.save_weights('model-40-2.h5') 
