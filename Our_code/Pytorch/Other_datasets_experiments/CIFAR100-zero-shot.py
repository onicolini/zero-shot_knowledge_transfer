...
def main(n_batches,lr_gen,lr_stud,batch_size,test_batch_size,g_input_dim,ng,ns,test_freq,beta, t_depth, t_width,
    ...
    # Get the teacher
    teacher = Wide_ResNet(t_depth,t_width,0,100)
    ...
    # Create the student
    student = Wide_ResNet(s_depth,s_width,0,100)
    ...
    for i in range(n_batches):
        ...
        if(i % test_freq) == 0:
            ...
            gen_file = './trained_students/CIFAR100-generator-t' + str(t_depth) + '-' + str(t_width) + '-s-' + str(s_depth) + '-' + str(s_width) + '.pth'
...
s_depth = 16
s_width = 1
teacher_file = './CIFAR100-teacher-'+str(t_depth) + '-' + str(t_width) + '.pth'
student_file = './trained_students/CIFAR100-stud-t-' + str(t_depth) + '-' + str(t_width) + '-student-' + str(s_depth) + '-' + str(s_width) + '.pth'
device = 'cuda:0'
teach_device= 'cuda:0'
