...
s_depth = 16
s_width = 1
teacher_file = '../trained_students/t-40-2-student-16-2.pth'
student_file = './trained_students/ablation_beta' + str(beta) + 't-' + str(t_depth) + '-' + str(t_width) + '-student-' + str(s_depth) + '-' + str(s_width) + '.pth'
device = 'cuda:0'
teach_device= 'cuda:0'
