...
if __name__ == "__main__":
    ...
    parser.add_argument('--n_images_per_class', type=int, default=200, help='=M in paper, -1 for all images')
    ...
    parser.add_argument('--KT_mode', type=str, default='KD+AT', choices=['KD', 'AT', 'KD+AT'], help='type of knowledge transfer loss')
    parser.add_argument('--pretrained_models_path', type=str, default='./pretrained/')
